...
defmodule SDKAPI.Connection do
  ...
  @doc """
  Configure a SDKAPI client.

  ### Parameters

  - `options`: an optional keyword list of SDKAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:togglr_client, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - SDKAPI 1.0.0 - elixir"
        )
      )
